...
import CardBeneficiaryCommerce from '../CardBeneficiaryCommerce/CardBeneficiaryCommerce'
// Import assets
    ...
    <div className={`KycEcommerceForm ${className}`}>
      {
        ...
        activeSection === 1 && (
          <div className="section__kyc--commerce">
            <h2 className="title">Información general</h2>

            <div className="content__kyc--commerce">
              <div className="content__kyc--item">
                <div className="auto__columns--commerce">
                  {/**
                   *
...

      {
        ...
        activeSection === 2 && (
          <div className="section__kyc--commerce">
            <h2 className="label yellow">
              Propietarios beneficiarios y agente de control
            </h2>

            <div className="content">
              <div className="content__kyc--item beneficiaries">
                <div className="subsection">
                  <h3 className="subtitle label white">
                    6. Enumere cada propietario / beneficiario / entidad que
                    posee el 10 por ciento o más de la empresa
                  </h3>
                  {beneficialOwnerList && (
                    <CardBeneficiaryCommerce data={beneficialOwnerList} />
                  )}
                  ...
                  <div className="row__kyc--commerce">
                    <p className="paragraph">
                      ...
                      <strong className="name-legal-representative">
                        {state.legalRepresentative?.fullname || 'Sin Nombre'}
                      </strong>
