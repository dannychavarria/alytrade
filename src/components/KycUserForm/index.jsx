...
const KycUserForm = ({
  ...
  return (
    <div className={`KycUserForm ${className}`}>
      <div className="section__kyc--person">
        {!isReadOnly && (
          <>
            {secondaryTypeForm === 0 && (
        ...
        <div className="content__kyc--person">
          <div className="two__rows">
            <div className="content__kyc--item">
               ...
               *
               */}
              <div className="subsection__kyc--person">
            ...
            <div className="content__kyc--item">
              {
                 ...
                 */
                (userAge >= 18 || secondaryTypeForm !== 0) && (
                  <div className="subsection__kyc--person toshow">
                    <h3 className="subtitle">Preguntas de control</h3>
              ...
              <div className="subsection__kyc--person">
                {userAge < 18 && secondaryTypeForm === 0 && (
                  <h3 className=" subtitle">Foto de perfil y verificación</h3>
                )}
                ...
                {userAge >= 18 && secondaryTypeForm === 0 && (
                  <div className="subsection__kyc--person">
                    <h3 className="subtitle">Beneficiario</h3>
          ...
          <div className="content__kyc--item">
             ...
             */}
            <div className="subsection__kyc--person">
              <h3 className="subtitle">Nacionalidad y residencia</h3>
